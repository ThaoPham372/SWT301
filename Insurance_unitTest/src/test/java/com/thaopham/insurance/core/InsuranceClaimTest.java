package com.thaopham.insurance.core;
...
public class InsuranceClaimTest {
    ...
    @BeforeEach
    void setUp() {
        // phương thức này chạy trước mỗi test, giúp mỗi test độc lập
    ...
    void testConstructorEmptyClaimId() {
        assertThrows(IllegalArgumentException.class, () -> new InsuranceClaim("", 1000.0));
    }
    ...
    @Test
    @DisplayName("updateClaimAmount affects payout calculation after approval")
    void testUpdateClaimAmountAffectsPayout() {
        claim.updateClaimAmount(3000.0);
        claim.processClaim("Approved");

        assertEquals(2550.0, claim.calculatePayout(), 0.001);
    }
